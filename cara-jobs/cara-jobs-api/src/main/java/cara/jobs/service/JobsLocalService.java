...
/**
 * Provides the local service interface for Jobs. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JobsLocalServiceUtil
...
public interface JobsLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JobsLocalServiceUtil} to access the jobs local service. Add custom service methods to {@link cara.jobs.service.impl.JobsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jobs fetchJobsByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jobs getJobsByUuidAndGroupId(java.lang.String uuid, long groupId)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Jobs> getJobsesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
