...
/**
 * Provides the local service interface for Tasks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TasksLocalServiceUtil
...
public interface TasksLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TasksLocalServiceUtil} to access the tasks local service. Add custom service methods to {@link com.liferay.unilever.demo.cara.tasks.service.impl.TasksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Tasks fetchTasksByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Tasks getTasksByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Tasks> getTasksByJobId(long jobId, int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Tasks> getTasksesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
