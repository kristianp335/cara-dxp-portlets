...
myPortletUrl.setParameter("mvcPath", "/work/create.jsp");
...
<aui:input name="assignmentId" field="assignmentId" type="hidden" />
		...
		<div style="float: left; padding-left: 20px; min-width: 250px;">
			...
			<aui:field-wrapper required="true">
						<aui:input name="projectName" label="Project Name" readonly="readonly"></aui:input>
			</aui:field-wrapper>				
			<aui:field-wrapper required="true">
						<aui:input name="projectBrand" label="Project Brand" readonly="readonly"></aui:input>
			</aui:field-wrapper>			
			<aui:field-wrapper required="true">
						<aui:input name="projectCategory" label="Project Category" readonly="readonly"></aui:input>
			</aui:field-wrapper>			
		...
		<div style="float: left; padding-left: 20px; min-width: 250px;">
			<aui:field-wrapper required="true">
						<aui:input name="projectType" label="Project Type" readonly="readonly"></aui:input>
			</aui:field-wrapper>	
			<aui:field-wrapper required="true">
						<aui:input name="brandPosition" label="Project Type" readonly="readonly"></aui:input>
			</aui:field-wrapper>
			
			<aui:field-wrapper required="true">
						<aui:input name="charterDate" label="Charter Date Approval" readonly="readonly"></aui:input>
			</aui:field-wrapper>
		</div>
		...
		<div class="userSearchFields" style="float: left; padding-left: 20px; min-width: 300px;">
			<aui:field-wrapper required="true">			
						<aui:input name="marketingUser" id="marketingUser" label="Marketing User" readonly="readonly">
						</aui:input>
						<aui:input name="marketingUserId" id="marketingUserId" type = "hidden"/>
			</aui:field-wrapper>
			<aui:field-wrapper required="true">
						<aui:input name="rndProductDevelopmentUser" id="rndProductDevelopmentUser" label="R&D Product Development User" readonly="readonly">
						
						</aui:input>
						<aui:input name="rndProductDevelopmentUserId" id="rndProductDevelopmentUserId" type = "hidden"/>
			</aui:field-wrapper>
						<aui:field-wrapper required="true">
						<aui:input name="technicalProjectLeaderUser" id="technicalProjectLeaderUser" label="R&D Product Development User" readonly="readonly">
		...
		<div class="userSearchFields" style="float: left; padding-left: 20px; min-width: 300px;">
			<aui:field-wrapper required="true">
						<aui:input name="rndUser" id="rndUser" label="R&D Deploy User" readonly="readonly">
						
						</aui:input>
						<aui:input name="rndUserId" id="rndUserId" type = "hidden"/>
			</aui:field-wrapper>
			<aui:field-wrapper required="true">
						<aui:input name="supplyChainUser" id="supplyChainUser" label="Supply Chain User" readonly="readonly">
						...
						<aui:input name="customerDevelopmentUser" id="customerDevelopmentUser" label="Customer Development User" readonly="readonly">
