...
/**
 * Provides the local service interface for Join. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JoinLocalServiceUtil
...
public interface JoinLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JoinLocalServiceUtil} to access the join local service. Add custom service methods to {@link com.liferay.unilever.demo.cara.join.service.impl.JoinLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	* @return the new join
	*/
	public Join createJoin(long jobId);
	...
	*/
	...
	public Join deleteJoin(Join join);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Join deleteJoin(long jobId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Join fetchJoin(long jobId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Join getJoin(long jobId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Join> getJoins(int start, int end);
